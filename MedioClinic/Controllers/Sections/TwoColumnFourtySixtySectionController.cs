...
[assembly: RegisterSection("MedioClinic.SectionFourtySixty.TwoColumn", 
    typeof(TwoColumnFourtySixtySectionController), "{$Section.TwoColumnFourtySixty.Name$}", 
    Description = "{$Section.TwoColumnFourtySixty.Description$}", 
